...
- **インクリボン**：印字点に選択色のリボンが横たわり、打鍵で持ち上がってアームが叩く（実機の動き）。
- **プラテン表示**：紙は黒いローラーに巻かれ、1 行目は紙の上端が見え、後ろに黒ローラー、その奥に送られた用紙の裏面。改行すると上端がローラーへ巻き上がり、前面に見えるのは数行（実機どおり）。上から**ペーパーベイル**が紙を押さえる。
